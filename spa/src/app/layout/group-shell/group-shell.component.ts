      ...
      <div class="drawer-side z-10">
        ...
        <aside class="bg-base-200 w-64 min-h-full flex flex-col">
          ...
          <div class="p-4 border-b border-base-300">
            <a routerLink="/groups" class="btn btn-ghost btn-sm gap-2 mb-2">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/>
              </svg>
              {{ 'NAV.GROUPS' | translate }}
            </a>
            <h2 class="font-bold text-lg truncate">{{ group()?.name ?? '...' }}</h2>
            @if (group()) {
          ...
          <nav class="flex-1 p-2">
            <ul class="menu menu-sm gap-1">
              <li>
                <a [routerLink]="['rueda']" routerLinkActive="active">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <li>
                <a [routerLink]="['ruedas']" routerLinkActive="active">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <li>
                <a [routerLink]="['parallel-loans']" routerLinkActive="active">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <li>
                <a [routerLink]="['cash-box']" routerLinkActive="active">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
